...
return this.__repr__();
    ...
    (function(){
        ...
        Base.prototype.log_interface = function log_interface() {
            var object = this;
            var prop;
            var ρσ_Iter1 = ρσ_Iterable(object);
            for (var ρσ_Index1 = 0; ρσ_Index1 < ρσ_Iter1.length; ρσ_Index1++) {
        ...
        Base.prototype.perform_vDev_detection = function perform_vDev_detection(detectType) {
            ...
            vDev = null;
            var ρσ_Iter2 = ρσ_Iterable(detectType);
            for (var ρσ_Index2 = 0; ρσ_Index2 < ρσ_Iter2.length; ρσ_Index2++) {
                testType = ρσ_Iter2[ρσ_Index2];
                definition = detectType[(typeof testType === "number" && testType < 0) ? detectType.length + testType : testType];
                if (_.isArray(definition) === false) {
                    definition = ρσ_list_decorate([ definition ]);
                }
                controller = self.bridge.controller;
                var ρσ_Iter3 = ρσ_Iterable(definition);
                for (var ρσ_Index3 = 0; ρσ_Index3 < ρσ_Iter3.length; ρσ_Index3++) {
        ...
        Base.prototype.check_alarm_supported = function check_alarm_supported(alarm, mask) {
            ...
            i = 0;
            t = 0;
            var ρσ_Iter4 = ρσ_Iterable(mask);
            for (var ρσ_Index4 = 0; ρσ_Index4 < ρσ_Iter4.length; ρσ_Index4++) {
                b = ρσ_Iter4[ρσ_Index4];
                t += b << i*8;
                i += 1;
            }
            return t & alarm > 0;
...
return this.__repr__();
        ...
        function RGB() {
            if (this.ρσ_object_id === undefined) Object.defineProperty(this, "ρσ_object_id", {"value":++ρσ_object_counter});
            RGB.prototype.__init__.apply(this, arguments);
        }
        ρσ_extends(RGB, Base);
        Object.defineProperties(RGB.prototype,  {
            "rgb": {
                "enumerable": true, 
                "get": function rgb() {
                    var self = this;
        ...
        RGB.prototype.__init__ = function __init__ () {
            Base.prototype.__init__ && Base.prototype.__init__.apply(this, arguments);
        };
        RGB.prototype.hsv2rgb = function hsv2rgb(hsv) {
            var self = this;
            var sfrac, vfrac, vb, hdb60, sector, fpart, c, x1, x2, r, g, b;
            sfrac = hsv.s / 100;
            vfrac = hsv.v / 100;
            if ((sfrac === 0 || typeof sfrac === "object" && ρσ_equals(sfrac, 0))) {
        ...
        if (!RGB.prototype.hsv2rgb.__argnames__) Object.defineProperties(RGB.prototype.hsv2rgb, {
            __argnames__ : {value: ["hsv"]}
        });
        RGB.prototype.rgb2hsv = function rgb2hsv(rgb) {
            var self = this;
            ...
            if ((min === max || typeof min === "object" && ρσ_equals(min, max))) {
                return (function(){
                    var ρσ_d = {};
                    ρσ_d["h"] = 0;
                    ρσ_d["s"] = 0;
            ...
            d = null;
            if ((r === min || typeof r === "object" && ρσ_equals(r, min))) {
                d = g - b;
            } else if ((b === min || typeof b === "object" && ρσ_equals(b, min))) {
                d = r - g;
            } else {
                d = b - r;
            }
        ...
        if (!RGB.prototype.rgb2hsv.__argnames__) Object.defineProperties(RGB.prototype.rgb2hsv, {
            __argnames__ : {value: ["rgb"]}
        });
        RGB.prototype.__repr__ = function __repr__ () {
            if(Base.prototype.__repr__) return Base.prototype.__repr__.call(this);
            return "<" + __name__ + "." + this.constructor.name + " #" + this.ρσ_object_id + ">";
        };
        RGB.prototype.__str__ = function __str__ () {
            if(Base.prototype.__str__) return Base.prototype.__str__.call(this);
return this.__repr__();
        };
        Object.defineProperty(RGB.prototype, "__bases__", {value: [Base]});
...
return this.__repr__();
        ...
        ρσ_extends(Brightness2RGB, RGB);
        Brightness2RGB.prototype.__init__ = function __init__ () {
            RGB.prototype.__init__ && RGB.prototype.__init__.apply(this, arguments);
        };
        Brightness2RGB.prototype.add_to_callback = function add_to_callback() {
            var self = this;
            var c, d;
        ...
        Brightness2RGB.prototype.remove = function remove() {
            var self = this;
            if (_.isObject(self.vDev)) {
                self.vDev.off("change:metrics:level", self.onLevelChange);
            }
        ...
        Brightness2RGB.prototype.__repr__ = function __repr__ () {
            if(RGB.prototype.__repr__) return RGB.prototype.__repr__.call(this);
            return "<" + __name__ + "." + this.constructor.name + " #" + this.ρσ_object_id + ">";
        };
        Brightness2RGB.prototype.__str__ = function __str__ () {
            if(RGB.prototype.__str__) return RGB.prototype.__str__.call(this);
return this.__repr__();
        };
        Object.defineProperty(Brightness2RGB.prototype, "__bases__", {value: [RGB]});
...
return this.__repr__();
        ...
        ρσ_extends(ChargingState, Base);
        ChargingState.prototype.__init__ = function __init__ () {
            Base.prototype.__init__ && Base.prototype.__init__.apply(this, arguments);
        };
        ChargingState.prototype.add_to_callback = function add_to_callback() {
            var self = this;
            var c;
            self.name = "Charging State";
            self.vDev = -1;
            c = self.service.addCharacteristic(HomeKit.Characteristics.ChargingState, "uint8", (function(){
                var ρσ_d = {};
                ρσ_d["get"] = function () {
                    return 2;
                };
...
return this.__repr__();
        ...
        Object.defineProperty(ChargingState.prototype, "__bases__", {value: [Base]});
...
return this.__repr__();
        ...
        ρσ_extends(Hue, RGB);
        Hue.prototype.__init__ = function __init__ () {
            RGB.prototype.__init__ && RGB.prototype.__init__.apply(this, arguments);
        };
        Hue.prototype.add_to_callback = function add_to_callback() {
            var self = this;
            var c, d;
            self.name = "Hue";
            c = null;
            ...
            if ((typeof d !== "undefined" && d !== null)) {
                self.vDev = d;
                c = self.service.addCharacteristic(HomeKit.Characteristics.Hue, "float", (function(){
                    var ρσ_d = {};
                    ρσ_d["get"] = function () {
        ...
        Hue.prototype.remove = function remove() {
            var self = this;
            if (_.isObject(self.vDev)) {
                self.vDev.off("change:metrics:level", self.onLevelChange);
            }
...
return this.__repr__();
        ...
        Object.defineProperty(Hue.prototype, "__bases__", {value: [RGB]});
        ...
        On.prototype.add_to_callback = function add_to_callback() {
            ...
            if ((typeof d !== "undefined" && d !== null)) {
                ...
                c = self.service.addCharacteristic(HomeKit.Characteristics.On, "bool", (function(){
                    var ρσ_d = {};
                    ρσ_d["get"] = function () {
                        return ρσ_equals(self.vDev.get("metrics:level"), "on");
                    };
                    ρσ_d["set"] = (function() {
                        var ρσ_anonfunc = function (value) {
                            self.vDev.performCommand((value === true) ? "on" : "off");
                        };
                        if (!ρσ_anonfunc.__argnames__) Object.defineProperties(ρσ_anonfunc, {
                            __argnames__ : {value: ["value"]}
                        });
...
return this.__repr__();
        ...
        ρσ_extends(OutletInUse, Base);
        OutletInUse.prototype.__init__ = function __init__ () {
            Base.prototype.__init__ && Base.prototype.__init__.apply(this, arguments);
        };
        OutletInUse.prototype.add_to_callback = function add_to_callback() {
            var self = this;
            var c;
            self.name = "OutletInUse";
            c = null;
            self.vDev = -1;
            c = self.service.addCharacteristic(HomeKit.Characteristics.OutletInUse, "bool", (function(){
                var ρσ_d = {};
                ρσ_d["get"] = function () {
                    return true;
                };
...
return this.__repr__();
        ...
        Object.defineProperty(OutletInUse.prototype, "__bases__", {value: [Base]});
...
return this.__repr__();
        ...
        ρσ_extends(Saturation, RGB);
        Saturation.prototype.__init__ = function __init__ () {
            RGB.prototype.__init__ && RGB.prototype.__init__.apply(this, arguments);
        };
        Saturation.prototype.add_to_callback = function add_to_callback() {
            var self = this;
            var c, d;
            ...
            if ((typeof d !== "undefined" && d !== null)) {
                self.vDev = d;
                c = self.service.addCharacteristic(HomeKit.Characteristics.Saturation, "float", (function(){
                    var ρσ_d = {};
                    ρσ_d["get"] = function () {
        ...
        Saturation.prototype.remove = function remove() {
            var self = this;
            if (_.isObject(self.vDev)) {
                self.vDev.off("change:metrics:level", self.onLevelChange);
            }
...
return this.__repr__();
        ...
        Object.defineProperty(Saturation.prototype, "__bases__", {value: [RGB]});
...
return this.__repr__();
        ...
        ρσ_extends(ServiceLabelNamespace, Base);
        ServiceLabelNamespace.prototype.__init__ = function __init__ () {
            Base.prototype.__init__ && Base.prototype.__init__.apply(this, arguments);
        };
        ServiceLabelNamespace.prototype.add_to_callback = function add_to_callback() {
            var self = this;
            self.vDev = -1;
            self.name = "ServiceLabelNamespace";
            return self.service.addCharacteristic(HomeKit.Characteristics.ServiceLabelNamespace, "uint8", (function(){
                var ρσ_d = {};
                ρσ_d["get"] = function () {
                    return 1;
                };
...
return this.__repr__();
        ...
        Object.defineProperty(ServiceLabelNamespace.prototype, "__bases__", {value: [Base]});
                    ...
                    ρσ_d["set"] = (function() {
                        var ρσ_anonfunc = function (value) {
                            ...
                            if (cc !== null) {
                                ...
                                var ρσ_Iter5 = ρσ_Iterable(self.thermostat);
                                for (var ρσ_Index5 = 0; ρσ_Index5 < ρσ_Iter5.length; ρσ_Index5++) {
            ...
            if (ρσ_exists.n(self.ccMode) || ρσ_exists.n(self.ccSetPoint)) {
                c = self.service.addCharacteristic(HomeKit.Characteristics.TemperatureDisplayUnits, "uint8", (function(){
                    ...
                    ρσ_d["get"] = function () {
                        ...
                        if (mode !== null) {
                            scale = (ρσ_expr_temp = self.ccSetPoint.data)[ρσ_bound_index(self.mode, ρσ_expr_temp)].scaleString.value;
...
return this.__repr__();
        ...
        function create(bridge4kt, realID, definition) {
            ...
            known_characteristics = (function(){
                ...
                ρσ_d["Brightness2RGB"] = Brightness2RGB;
        ...
        ρσ_modules.characteristics.out = out;
        ρσ_modules.characteristics.Base = Base;
        ρσ_modules.characteristics.BinarySensorState = BinarySensorState;
        ρσ_modules.characteristics.MultilevelSensorState = MultilevelSensorState;
        ρσ_modules.characteristics.SlatSupport = SlatSupport;
        ρσ_modules.characteristics.RGB = RGB;
        ρσ_modules.characteristics.BatteryLevel = BatteryLevel;
        ρσ_modules.characteristics.Brightness2RGB = Brightness2RGB;
        ρσ_modules.characteristics.CarbonDioxideDetected = CarbonDioxideDetected;
        ρσ_modules.characteristics.CarbonMonoxideDetected = CarbonMonoxideDetected;
        ρσ_modules.characteristics.ChargingState = ChargingState;
        ρσ_modules.characteristics.ContactSensorState = ContactSensorState;
        ρσ_modules.characteristics.CurrentHeatingCoolingState = CurrentHeatingCoolingState;
        ρσ_modules.characteristics.CurrentPositionB = CurrentPositionB;
        ρσ_modules.characteristics.CurrentPositionC = CurrentPositionC;
        ρσ_modules.characteristics.CurrentPositionSimple = CurrentPositionSimple;
        ρσ_modules.characteristics.CurrentRelativeHumidity = CurrentRelativeHumidity;
        ρσ_modules.characteristics.CurrentSlatState = CurrentSlatState;
        ρσ_modules.characteristics.CurrentTemperature = CurrentTemperature;
        ρσ_modules.characteristics.CurrentTiltAngle = CurrentTiltAngle;
        ρσ_modules.characteristics.CurrentHorizontalTiltAngle = CurrentHorizontalTiltAngle;
        ρσ_modules.characteristics.CurrentVerticalTiltAngle = CurrentVerticalTiltAngle;
        ρσ_modules.characteristics.HoldPosition = HoldPosition;
        ρσ_modules.characteristics.Hue = Hue;
        ρσ_modules.characteristics.LeakDetected = LeakDetected;
        ρσ_modules.characteristics.MotionDetected = MotionDetected;
        ρσ_modules.characteristics.Name = Name;
        ρσ_modules.characteristics.OccupancyDetected = OccupancyDetected;
        ρσ_modules.characteristics.On = On;
        ρσ_modules.characteristics.OutletInUse = OutletInUse;
        ρσ_modules.characteristics.PositionState = PositionState;
        ρσ_modules.characteristics.ProgrammableSwitchEvent = ProgrammableSwitchEvent;
        ρσ_modules.characteristics.Saturation = Saturation;
        ρσ_modules.characteristics.ServiceLabelIndex = ServiceLabelIndex;
        ρσ_modules.characteristics.ServiceLabelNamespace = ServiceLabelNamespace;
        ρσ_modules.characteristics.SlatType = SlatType;
        ρσ_modules.characteristics.SmokeDetected = SmokeDetected;
        ρσ_modules.characteristics.StatusActive = StatusActive;
        ρσ_modules.characteristics.StatusFault = StatusFault;
        ρσ_modules.characteristics.StatusLowBattery = StatusLowBattery;
        ρσ_modules.characteristics.StatusTampered = StatusTampered;
        ρσ_modules.characteristics.SwingMode = SwingMode;
        ρσ_modules.characteristics.TargetHeatingCoolingState = TargetHeatingCoolingState;
        ρσ_modules.characteristics.TargetPositionA = TargetPositionA;
        ρσ_modules.characteristics.TargetPositionB = TargetPositionB;
        ρσ_modules.characteristics.TargetPositionC = TargetPositionC;
        ρσ_modules.characteristics.TargetPositionSimple = TargetPositionSimple;
        ρσ_modules.characteristics.TargetTemperature = TargetTemperature;
        ρσ_modules.characteristics.TargetTiltAngle = TargetTiltAngle;
        ρσ_modules.characteristics.TargetHorizontalTiltAngle = TargetHorizontalTiltAngle;
        ρσ_modules.characteristics.TargetVerticalTiltAngle = TargetVerticalTiltAngle;
        ρσ_modules.characteristics.TemperatureDisplayUnits = TemperatureDisplayUnits;
        ρσ_modules.characteristics.create = create;
    })();
    ...
    (function(){
        ...
        var characteristics = ρσ_modules.characteristics;
        ...
        Base.prototype.generateUUID = function generateUUID() {
            var self = this;
...
return this.__repr__();
        ...
        ρσ_extends(BridgingState, Base);
        BridgingState.prototype.__init__ = function __init__ () {
            Base.prototype.__init__ && Base.prototype.__init__.apply(this, arguments);
        };
        BridgingState.prototype.add_to = function add_to(accessory) {
            var self = this;
            var s;
            s = accessory.addService(HomeKit.Services.BridgingState, "BridgingState");
            console.log(". HK Service 'BridgingState' added");
            s.addCharacteristic(HomeKit.Characteristics.Reachable, "bool", true, ρσ_list_decorate([ "pr", "ev" ]));
            s.addCharacteristic(HomeKit.Characteristics.LinkQuality, "uint8", 1, ρσ_list_decorate([ "pr", "ev" ]), (function(){
                var ρσ_d = {};
                ρσ_d["maxValue"] = 4;
                ρσ_d["minValue"] = 1;
                ρσ_d["minStep"] = 1;
            ...
            s.addCharacteristic(HomeKit.Characteristics.Category, "uint16", 1, ρσ_list_decorate([ "pr", "ev" ]), (function(){
                var ρσ_d = {};
                ρσ_d["maxValue"] = 16;
                ρσ_d["minValue"] = 1;
                ρσ_d["minStep"] = 1;
        ...
        if (!BridgingState.prototype.add_to.__annotations__) Object.defineProperties(BridgingState.prototype.add_to, {
            __annotations__ : {value: {accessory: HKAccessory, return: HKService}},
            __argnames__ : {value: ["accessory"]}
        });
...
return this.__repr__();
        ...
        Object.defineProperty(BridgingState.prototype, "__bases__", {value: [Base]});
...
return this.__repr__();
        ...
        Lightbulb.prototype.__init__ = function __init__(bridge4kt, id) {
            ...
            self.name = "Lightbulb";
            self.definition = ρσ_list_decorate([ "On", "Name", "Brightness2RGB", "Hue", "Saturation" ]);
        };
...
return this.__repr__();
        ...
        function LightbulbCT() {
            if (this.ρσ_object_id === undefined) Object.defineProperty(this, "ρσ_object_id", {"value":++ρσ_object_counter});
            LightbulbCT.prototype.__init__.apply(this, arguments);
        }
        ρσ_extends(LightbulbCT, Default);
        LightbulbCT.prototype.__init__ = function __init__(bridge4kt, id) {
            var self = this;
            Default.prototype.__init__.call(self, bridge4kt, id);
            self.serviceID = HomeKit.Services.Lightbulb;
            self.name = "Lightbulb";
            self.definition = ρσ_list_decorate([ "On", "Name", "Brightness", "ColorTemperature" ]);
        };
        if (!LightbulbCT.prototype.__init__.__argnames__) Object.defineProperties(LightbulbCT.prototype.__init__, {
            __argnames__ : {value: ["bridge4kt", "id"]}
        });
        LightbulbCT.__argnames__ = LightbulbCT.prototype.__init__.__argnames__;
        LightbulbCT.__handles_kwarg_interpolation__ = LightbulbCT.prototype.__init__.__handles_kwarg_interpolation__;
        LightbulbCT.prototype.__repr__ = function __repr__ () {
            if(Default.prototype.__repr__) return Default.prototype.__repr__.call(this);
            return "<" + __name__ + "." + this.constructor.name + " #" + this.ρσ_object_id + ">";
        };
        LightbulbCT.prototype.__str__ = function __str__ () {
            if(Default.prototype.__str__) return Default.prototype.__str__.call(this);
return this.__repr__();
        };
        Object.defineProperty(LightbulbCT.prototype, "__bases__", {value: [Default]});
...
return this.__repr__();
        ...
        ρσ_modules.services.LightbulbCT = LightbulbCT;
    ...
    (function(){
        ...
        Main.prototype.__init__ = function __init__(bridge4kt, id) {
            ...
            self.config = (function(){
                var ρσ_d = {};
                ρσ_d["name"] = "Bridge4KT";
                ρσ_d["manufacturer"] = "Ralph Wetzel";
                ρσ_d["model"] = "1.0";
                ρσ_d["serial"] = "Not provided";
                return ρσ_d;
            }).call(this);
        };
...
return this.__repr__();
        ...
        Creator.prototype.add_to = function add_to(collection) {
            var self = this;
            var is_primary, s, ac, index, detectType, vDev, states, inst, sli, i, ds, service, ρσ_unpack, bs;
            is_primary = false;
            s = self.definition[0];
            ...
            ac = Base.prototype.add_to.call(self, collection);
            index = 0;
            var ρσ_Iter2 = ρσ_Iterable(enumerate(self.definition));
            for (var ρσ_Index2 = 0; ρσ_Index2 < ρσ_Iter2.length; ρσ_Index2++) {
        ...
        Creator.prototype.update = function update() {
            var self = this;
            var service;
            var ρσ_Iter4 = ρσ_Iterable(self.services);
            for (var ρσ_Index4 = 0; ρσ_Index4 < ρσ_Iter4.length; ρσ_Index4++) {
...
return this.__repr__();
    ...
    (function(){
        ...
        function out() {
            var key;
            var ρσ_Iter6 = ρσ_Iterable(arguments);
            for (var ρσ_Index6 = 0; ρσ_Index6 < ρσ_Iter6.length; ρσ_Index6++) {
        ...
        Bridge4KT.prototype.merge_definition_with_tags = function merge_definition_with_tags(pDev, definition) {
            ...
            var ρσ_Iter7 = ρσ_Iterable(devices);
            for (var ρσ_Index7 = 0; ρσ_Index7 < ρσ_Iter7.length; ρσ_Index7++) {
                d = ρσ_Iter7[ρσ_Index7];
                device = devices[(typeof d === "number" && d < 0) ? devices.length + d : d];
                tags = device.tags;
                var ρσ_Iter8 = ρσ_Iterable(tags);
                for (var ρσ_Index8 = 0; ρσ_Index8 < ρσ_Iter8.length; ρσ_Index8++) {
                    tag = ρσ_Iter8[ρσ_Index8];
                    t = str.split(tag, ":");
        ...
        Bridge4KT.prototype.process_changes = function process_changes(vDev_from_zway) {
            ...
            dd = ρσ_list_decorate([]);
            var ρσ_Iter10 = ρσ_Iterable(definition);
            ...
            zway = global["zway"];
            config_text = "";
            var ρσ_Iter11 = ρσ_Iterable(self.devices);
            for (var ρσ_Index11 = 0; ρσ_Index11 < ρσ_Iter11.length; ρσ_Index11++) {
                id = ρσ_Iter11[ρσ_Index11];
        ...
        Bridge4KT.prototype.init = function init(config) {
            ...
            function downloadJSON(file) {
                var response;
                response = http.request((function(){
                    var ρσ_d = {};
            ...
            self.hk = new HomeKit(config.name, (function() {
                var ρσ_anonfunc = function (r) {
                    ...
                    if ((r.method === "GET" || typeof r.method === "object" && ρσ_equals(r.method, "GET")) && (r.path === "/accessories" || typeof r.path === "object" && ρσ_equals(r.path, "/accessories"))) {
                        ...
                        var ρσ_Iter14 = ρσ_Iterable(r.data.characteristics);
                        for (var ρσ_Index14 = 0; ρσ_Index14 < ρσ_Iter14.length; ρσ_Index14++) {
                            c = ρσ_Iter14[ρσ_Index14];
                        ...
                        var ρσ_Iter15 = ρσ_Iterable(accessoriesCharacteristics);
                        for (var ρσ_Index15 = 0; ρσ_Index15 < ρσ_Iter15.length; ρσ_Index15++) {
                            ac = ρσ_Iter15[ρσ_Index15];
                            item = (function() {
        ...
        Bridge4KT.prototype.stop = function stop() {
            ...
            var ρσ_Iter16 = ρσ_Iterable(self.devices);
            for (var ρσ_Index16 = 0; ρσ_Index16 < ρσ_Iter16.length; ρσ_Index16++) {
                id = ρσ_Iter16[ρσ_Index16];
