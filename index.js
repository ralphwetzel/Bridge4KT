...
var str = ρσ_str, repr = ρσ_repr;;
    ...
    (function(){
        ...
        Base.prototype.perform_vDev_detection = function perform_vDev_detection(detectType) {
            var self = this;
            var vDev, definition, controller, endPoint, dspl, d, vDevList, testType;
            ...
            for (var ρσ_Index1 = 0; ρσ_Index1 < ρσ_Iter1.length; ρσ_Index1++) {
                ...
                for (var ρσ_Index2 = 0; ρσ_Index2 < ρσ_Iter2.length; ρσ_Index2++) {
                    ...
                    endPoint = null;
                    if ((testType === "deviceType" || typeof testType === "object" && ρσ_equals(testType, "deviceType"))) {
                        dspl = d.split(":");
                        d = dspl[0];
                        if (len(dspl) > 1) {
                    ...
                    if (len(vDevList) > 0) {
                        if ((typeof endPoint !== "undefined" && endPoint !== null)) {
                            if (endPoint > 0 && endPoint < len(vDevList)) {
                                vDev = vDevList[(typeof endPoint === "number" && endPoint < 0) ? vDevList.length + endPoint : endPoint];
                                break;
                            }
                        } else {
                            vDev = vDevList[0];
        ...
        Base.prototype.update = function update() {
            ...
            if ((typeof vDev !== "undefined" && vDev !== null)) {
                if (ρσ_exists.n(self.vDev) && (vDev.id !== self.vDev.id && (typeof vDev.id !== "object" || ρσ_not_equals(vDev.id, self.vDev.id))) || !ρσ_exists.n(self.vDev)) {
...
return this.__repr__();
        ...
        function detect_vDev(controller, pID, detectType, returnList) {
            ...
            if (!(typeof returnList !== "undefined" && returnList !== null) || (returnList !== true && (typeof returnList !== "object" || ρσ_not_equals(returnList, true)))) {
                returnList = false;
            }
            vDev = null;
            ...
            for (var ρσ_Index6 = 0; ρσ_Index6 < ρσ_Iter6.length; ρσ_Index6++) {
                ...
                for (var ρσ_Index7 = 0; ρσ_Index7 < ρσ_Iter7.length; ρσ_Index7++) {
                    ...
                    if (len(vDevList) > 0) {
                        vDev = (returnList === true) ? vDevList : vDevList[0];
                        break;
                    }
                }
                if ((typeof vDev !== "undefined" && vDev !== null)) {
        ...
        if (!detect_vDev.__argnames__) Object.defineProperties(detect_vDev, {
            __argnames__ : {value: ["controller", "pID", "detectType", "returnList"]}
        });
...
return this.__repr__();
        ...
        Name.prototype.add_to_callback = function add_to_callback() {
            var self = this;
            var c, d, detectTypeList;
            self.name = "Name";
            c = null;
            d = null;
            self.vDev = null;
            detectTypeList = ρσ_list_decorate([]);
            if (ρσ_exists.n(self.endPoint)) {
            ...
            c = self.service.addCharacteristic(HomeKit.Characteristics.Name, "string", (function(){
                ...
                ρσ_d["get"] = function () {
                    var name, dev;
                    name = null;
                    if (ρσ_exists.n(self.vDev) && (self.vDev !== -1 && (typeof self.vDev !== "object" || ρσ_not_equals(self.vDev, -1)))) {
...
return this.__repr__();
        ...
        On.prototype.add_to_callback = function add_to_callback() {
            ...
            if (ρσ_exists.n(self.endPoint)) {
                ...
                self.detectType = (function(){
                    var ρσ_d = {};
                    ρσ_d["tags"] = "B4KT:Switch:" + self.endPoint;
                    ρσ_d["deviceType"] = "switchBinary:" + self.endPoint;
                    return ρσ_d;
                }).call(this);
            } else {
                self.detectType = (function(){
        ...
        TargetPositionC.prototype.add_to_callback = function add_to_callback() {
            ...
            if ((typeof d !== "undefined" && d !== null)) {
                ...
                c = self.service.addCharacteristic(HomeKit.Characteristics.TargetPosition, "uint8", (function(){
                    ...
                    ρσ_d["get"] = function () {
                        ouit(self.vDev);
                        out("** GetC: (" + "" + ") => Display: " + self.display + " / Target: " + self.target);
                        return self.map_zway_to_hk(self.display);
                    };
                    ρσ_d["set"] = (function() {
                        var ρσ_anonfunc = function (value) {
                            ...
                            if (0 < value && value < 100) {
                                self.target = self.display = self.map_hk_to_zway(value);
                                out("** SetC: => Current: " + current + " / Display: " + self.display + " / Target: " + self.target);
                                self.set_level(self.target);
                                return;
                            }
                            if (self.trigger === null) {
...
return this.__repr__();
    ...
    (function(){
        ...
        Default.prototype.add_char_to_service = function add_char_to_service(char, service) {
            var self = this;
            char.add_to(service);
        };
        if (!Default.prototype.add_char_to_service.__argnames__) Object.defineProperties(Default.prototype.add_char_to_service, {
            __argnames__ : {value: ["char", "service"]}
        });
...
return this.__repr__();
        ...
        ρσ_extends(Fan, Base);
        Fan.prototype.__init__ = function __init__(bridge4kt, id) {
            var self = this;
            Default.prototype.__init__.call(self, bridge4kt, id);
        ...
        if (!Fan.prototype.__init__.__argnames__) Object.defineProperties(Fan.prototype.__init__, {
            __argnames__ : {value: ["bridge4kt", "id"]}
        });
        Fan.__argnames__ = Fan.prototype.__init__.__argnames__;
        Fan.__handles_kwarg_interpolation__ = Fan.prototype.__init__.__handles_kwarg_interpolation__;
...
return this.__repr__();
        ...
        Switch.prototype.add_char_to_service = function add_char_to_service(char, service) {
            var self = this;
            if (ρσ_exists.n(self.endPoint)) {
        ...
        if (!Switch.prototype.add_char_to_service.__argnames__) Object.defineProperties(Switch.prototype.add_char_to_service, {
            __argnames__ : {value: ["char", "service"]}
        });
...
return this.__repr__();
    ...
    (function(){
        ...
        Main.prototype.add_to = function add_to(collection) {
            ...
            if (ρσ_exists.n(HomeKit.Characteristics.State)) {
            ...
            if (ρσ_exists.n(HomeKit.Characteristics.ControlPoint)) {
...
return this.__repr__();
        ...
        Creator.prototype.add_to = function add_to(collection) {
            var self = this;
            var HSAccessoryInformation, HCIdentify, is_primary, s, ac, index, definition, detectType, vDev, states, inst, sli, i, ds, service, pDev, cc, endPoints, eP, char, ρσ_unpack;
            ...
            if (ρσ_in(s, self.known_acc)) {
                ...
                is_primary = true;
            } else if (s.toLowerCase().indexOf("switch") > -1) {
                self.name = "Switch";
                is_primary = true;
            } else {
                self.name = "Other";
            ...
            for (var ρσ_Index2 = 0; ρσ_Index2 < ρσ_Iter2.length; ρσ_Index2++) {
                ...
                } else if ((service === "Switch" || typeof service === "object" && ρσ_equals(service, "Switch"))) {
                    pDev = new devices.pDevice(self.id);
                    cc = pDev.commandClass(96);
                    if ((typeof cc !== "undefined" && cc !== null) && ρσ_exists.n(cc.data) && ρσ_exists.n(cc.data.endPoints)) {
                        endPoints = cc.data.endPoints.value;
                        if ((typeof endPoints !== "undefined" && endPoints !== null)) {
                            for (var ρσ_Index4 = 1; ρσ_Index4 < endPoints + 1; ρσ_Index4++) {
                                eP = ρσ_Index4;
                                s = services.create(self.bridge, self.id, service);
                                if ((typeof s !== "undefined" && s !== null)) {
                                    s.endPoint = eP;
                                    (ρσ_expr_temp = self.services)[ρσ_bound_index(service + "." + eP, ρσ_expr_temp)] = s;
                ...
                if ((typeof s !== "undefined" && s !== null)) {
                    if ((index === 0 || typeof index === "object" && ρσ_equals(index, 0)) && is_primary === true) {
                        var ρσ_Iter5 = ρσ_Iterable(ac.services);
                        for (var ρσ_Index5 = 0; ρσ_Index5 < ρσ_Iter5.length; ρσ_Index5++) {
                            service = ρσ_Iter5[ρσ_Index5];
                            if ((service.type === HSAccessoryInformation || typeof service.type === "object" && ρσ_equals(service.type, HSAccessoryInformation))) {
                                var ρσ_Iter6 = ρσ_Iterable(service.characteristics);
                                for (var ρσ_Index6 = 0; ρσ_Index6 < ρσ_Iter6.length; ρσ_Index6++) {
                                    char = ρσ_Iter6[ρσ_Index6];
        ...
        Creator.prototype.update = function update() {
            var self = this;
            var service;
            var ρσ_Iter7 = ρσ_Iterable(self.services);
            for (var ρσ_Index7 = 0; ρσ_Index7 < ρσ_Iter7.length; ρσ_Index7++) {
                service = ρσ_Iter7[ρσ_Index7];
...
return this.__repr__();
        ...
        Creator.prototype.known_acc = ρσ_list_decorate([ "Fan", "Garage", "Lightbulb", "Outlet", "Switch", "Thermostat", "Sensor", "Door", "Window", "WindowCovering", "ProgrammableSwitch" ]);
